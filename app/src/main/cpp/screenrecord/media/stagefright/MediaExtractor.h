...
public:
    ...
    // Mediatek Android Patch Begin For DTCP-IP
    virtual bool setMediaDrmSession(const Vector<uint8_t> &/*sessionId*/) { return false; }
...
public:
    ...
    virtual status_t setMediaCas(const uint8_t* casToken, size_t size);
    // Mediatek Android Patch Begin For DTCP-IP
    virtual bool setMediaDrmSession(const Vector<uint8_t> &/*sessionId*/);
    // Mediatek Android Patch End
protected:
